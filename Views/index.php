    ...
    <section class="bg-light">
        <div class="container py-5">
            <div class="row text-center py-3">
                <div class="col-lg-6 m-auto">
                    <h1 class="h1">Producto Destacados</h1>
                    <p>
                    En el flujo del placer, críticas se deslizan, buscando ser invisibles como un cabello, 
                    evadiendo el dolor, pero sin encontrar renacimiento. Solo aquellos envueltos en la niebla 
                    de la lujuria permanecen atrapados. Libérate para crecer, abraza la conexión.
                    </p>
                </div>
            </div>
            <div class="row">
            ...
            <?php foreach ($data['nuevoProductos'] as $producto) {   ?>
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        <a href="<?php echo BASE_URL . 'principal/shopsingle/' . $producto['id']; ?>">
                        ...
                        <div class="card-body">
                            ...
                            <a href="<?php echo BASE_URL . 'principal/shopsingle/' . $producto['id']; ?>" class="h2 text-decoration-none text-dark"> <?php echo $producto['nombre']; ?> </a>
                            <p class="card-text">
